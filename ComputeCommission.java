...
public class ComputeCommission
{
    public static void main(String[] args) {
        ...
        vType = input.next();
        System.out.println("Please enter the commission rate in decimals >>>>");
    ...
    public static void computeCommision(int value, double rate, char vehicle){
        double commision;
        commision = value * rate;
        System.out.println("\nThe " + vehicle + " type vehicle is worth $" + value);

        System.out.println("With " +(rate * 100) + "% commission rate, the commission is $" + commision);
    }
}
